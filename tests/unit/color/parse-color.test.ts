...
describe('parseColor', () => {
  ...
  describe('rgb colors', () => {
    ...
    it('should parse rgba() with alpha', () => {
      ...
      expect(result).toEqual({ r: 1, g: 0.341, b: 0.2, a: 0.5 });
    });
  ...
  describe('named colors', () => {
    it('should parse common named colors', () => {
      ...
      expect(parseColor('green')).toEqual({ r: 0, g: 0.502, b: 0, a: 1 });
  ...
  describe('edge cases', () => {
    it('should handle whitespace', () => {
      expect(parseColor('  #FF5733  ')).toEqual({ r: 1, g: 0.341, b: 0.2, a: 1 });
      expect(parseColor('  red  ')).toEqual({ r: 1, g: 0, b: 0, a: 1 });
    });
